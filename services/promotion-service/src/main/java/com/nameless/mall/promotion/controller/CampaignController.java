...
public class CampaignController {
    ...
    public Result<List<MarketingCampaignVO>> getCampaigns() {
        List<MarketingCampaign> campaigns = marketingCampaignService.getActiveCampaigns();
    ...
    public Result<MarketingCampaignVO> getByCode(@PathVariable String code) {
        MarketingCampaign campaign = marketingCampaignService.getByCode(code);
        if (campaign == null) {
    ...
    private MarketingCampaignVO convertToVO(MarketingCampaign entity) {
