...
public class FlashSaleStartupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        log.info("Starting Flash Sale Data Consistency Check...");
        try {
            flashSalePromotionService.syncPromotionStock();
            log.info("Flash Sale Data Consistency Check Completed.");
        } catch (Exception e) {
            log.error("Flash Sale Data Consistency Check Failed", e);
            // 不阻斷啟動，但記錄錯誤
        }
    }
}
