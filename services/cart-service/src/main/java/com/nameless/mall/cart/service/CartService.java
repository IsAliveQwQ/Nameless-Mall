...
public interface CartService {
     ...
     */
    CartVO addToCart(Long variantId, Integer quantity);
     ...
     * @return 更新後的完整購物車內容
     */
    CartVO updateItemQuantity(Long variantId, Integer quantity);
     ...
     * @return 更新後的完整購物車內容
     */
    CartVO removeItem(Long... variantIds);
    ...
    List<CartItemDTO> getCartItemsByIds(List<Long> cartItemIds);

    /**
     * [新增] 根據購物車項目 ID 列表，從購物車中清除對應的項目。
     * <p>
     * 專為內部 Feign 呼叫設計。
     *
