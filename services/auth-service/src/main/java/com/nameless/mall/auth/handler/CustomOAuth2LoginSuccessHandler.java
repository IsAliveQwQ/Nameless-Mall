...
public class CustomOAuth2LoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private UserAuthDTO findOrCreateLocalUser(OAuth2UserInfo userInfo) {
        ...
        if (internalUser == null) {
            ...
            throw new RuntimeException("User Service unavailable or returned invalid result");
        }
    ...
    private String generateJwtForUser(UserAuthDTO internalUser) {
        ...
        // [Fix] Principal 必須是 userId (String)，而非 username
        // 因為 JwtTokenService 會將 Principal 作為 JWT subject
        // 而 User Service 期待 subject 是可解析為 Long 的 userId
