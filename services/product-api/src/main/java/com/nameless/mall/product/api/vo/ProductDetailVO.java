...
/**
 * 商品詳情 VO (Product Detail Page View Object)
 * <p>
 * 專為前端詳情頁渲染設計，包含：
 * 1. 核心資訊 (標題、價格、銷量)
 * 2. 視覺資訊 (多圖、標籤)
 * 3. 規格選擇器 (Display Options)
 * 4. 完整的 SKU 列表 (用於計算庫存和價格)
 */
@Data
public class ProductDetailVO implements Serializable {
    ...
    /**
     * 完整的 SKU 變體列表
     * 前端根據 displayOptions 選擇後，比對此列表找到對應的 SKU ID 和價格
     */
