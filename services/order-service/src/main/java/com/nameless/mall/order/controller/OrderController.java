...
public class OrderController {
    ...
    public Result<OrderVO> submitOrder(@Valid @RequestBody OrderSubmitDTO submitDTO) {
        OrderVO order = orderService.submitOrder(submitDTO);
    ...
    public Result<Page<OrderVO>> getOrderList(
        ...
        Page<OrderVO> orderPage = orderService.findPage(pageNum, pageSize, status);
     ...
     */
    @GetMapping("/{orderSn}")
    public Result<OrderDetailVO> getOrderDetail(@PathVariable String orderSn) {
        OrderDetailVO orderDetail = orderService.getOrderDetailBySn(orderSn);
    ...
    public Result<OrderVO> getOrderStatus(@PathVariable String orderSn) {
        OrderVO status = orderService.getOrderCreationStatus(orderSn);
    ...
    public Result<Void> confirmReceipt(@PathVariable String orderSn) {
