...
public interface OrderService extends IService<Order> {
    ...
    Page<OrderVO> findPage(Integer pageNum, Integer pageSize, Integer status);
     ...
     * @return 訂單詳情 VO
     */
    OrderDetailVO getOrderDetailBySn(String orderSn);
     ...
     */
    OrderVO getOrderCreationStatus(String orderSn);
